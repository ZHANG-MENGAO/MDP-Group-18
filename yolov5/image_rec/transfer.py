...
rpiServer = "192.168.18.1"
rpiUsername = "group18"
rpiPassword = "group18best"

rpiImageDirectory = "/home/group18/images"
...
ssh.connect(rpiServer, username=rpiUsername, password=rpiPassword)
# ssh.connect(username=rpiUsername, password=rpiPassword)
sftp = ssh.open_sftp()
