...
def run(
        weights: object = ROOT / 'yolov5s.pt',  # model.pt path(s)
        source: object = ROOT / 'images',  # file/dir/URL/glob, 0 for webcam
        data: object = ROOT / 'data/coco128.yaml',  # dataset.yaml path
        imgsz: object = (640, 640),  # inference size (height, width)
        ...
        device: object = '',  # cuda device, i.e. 0 or 0,1,2,3 or cpu
        ...
        dnn: object = False,  # use OpenCV DNN for ONNX inference
        vid_stride: object = 1,  # video frame-rate stride
) -> object:
    source = str(source)
...
def parse_opt():
    ...
    # change default to 'path to/model/run/weights/best.pt
    parser.add_argument('--weights', nargs='+', type=str, default='C:/Users/guanl/yolov5/image_rec/model/run/weights/best.pt', help='model path(s)')
    # change default to 'path to/model/images
    parser.add_argument('--source', type=str, default='C:/Users/guanl/yolov5/image_rec/model/images', help='file/dir/URL/glob, 0 for webcam')
